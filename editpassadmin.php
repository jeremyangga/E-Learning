<?php
	...
	$ambilpasslama;
	$ambilpasslama= "SELECT * from admin WHERE password='$password'";
	$res=mysqli_query($con,$ambilpasslama);
	...
	if(isset($_POST["ganti"]))
	{
		...
		else
		{
			...
			{
				$db="UPDATE admin SET password='$passbaru' where username='$username'";
