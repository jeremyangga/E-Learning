...
<!DOCTYPE html>
 ...
 <div class="container">
  <div class="jumbotron" align="center">
   <h1 style="center;">Lihat materi</h1>
   <form method="POST" action="">
    Materi<br>
      <textarea name="materi"></textarea><br><br>
      <button class="btn btn-primary btn-lg" type="submit" name="addmateri" id="addmateri">Lihat Materi</button>
     </form> 
    </div>
   </div>
   <br>
...
//   $id_detail_materi=$_SESSION["id_detailmateri"]
...
//   // if($a){
//   //   echo "Nilai sudah ditambahkan";
//   // }else{
//   //   echo "Nilai gagal ditambahkan";
//   // }
//   }
?>
